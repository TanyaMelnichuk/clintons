 ...
 * @endcode
 */
$settings['hash_salt'] = 'eNQnYNve2kVXcX-UNZbL22cLB8m-oxpfofRz3molRT9eQ8yRLbN615mJbUXjAflnQiZbJFsXhQ';
...
$config_directories['sync'] = 'sites/default/files/config_VDrkLhywht84tNuSKew3qNGasrRc1MFkQdADRVHPddc3mhiAx5ch6cSZ3Hqub_GpkGbozhnBQw/sync';
if (file_exists($app_root . '/' . $site_path . '/settings.local.php')) {
    include $app_root . '/' . $site_path . '/settings.local.php';
}